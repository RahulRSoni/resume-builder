                ...
                <Grid container rows={{ xs: 12, sm: 12, md: 6 }} rowSpacing={2}>
                    ...
                    <Grid item sm={12} md={6} sx={{ p: 2, mt: 6 }}>
                        ...
                        <Typography variant='body1' align="justify">
                            You create your professional resume in a quick and easy way. 15+ all type of templates like Professional, Tradisnal,and Morden way. All of which can be customized to your liking. Fast and Easy to Use Our resume builder lets you easily and quickly create a resume using our resume wizard.
                        </Typography>
            ...
            <Box sx={{ display: "flex", ml: 6 }} >
                <Grid container rows={{ xs: 12, sm: 12, md: 6 }} rowSpacing={2}>
                    <Grid item sm={12} md={6} sx={{ p: 2, mt: 15 }}>
                        ...
                        <Typography variant='body1' align="justify">
                            Ones you created your resume, Our text editor has everything you need to customize your resume. Download your resume and send it straight to the hiring manager. Whatever format you choose, we’ve got you covered.
                        </Typography>
                        <IconButton color="primary" component="label">
                            <Link to="/myresume">
                                <ArrowForwardIosIcon />
                ...
                <Grid container rows={{ xs: 12, sm: 12, md: 6 }} rowSpacing={2}>
                    ...
                    <Grid item sm={12} md={6} sx={{ p: 2, mt: 6 }}>
                        ...
                        <IconButton color="primary" component="label">
                            ...
                            <Typography variant='body1' align="justify">
                            Choose from over tem modern and professional templates. All of which can be customized to your liking.
                            </Typography>        
                        <Typography variant='h6' align="justify">
                            <IconButton color="primary" component="label">
                                <CheckIcon />
